...
class CSSDomain implements CSSDomainInterface
{
	...
	public function setContainerQueryConditionText(
		...
		$response = $this->internalClient->executeCommand($ctx, 'CSS.setContainerQueryConditionText', $request);
		return SetContainerQueryConditionTextResponse::fromJson($response);
	}
