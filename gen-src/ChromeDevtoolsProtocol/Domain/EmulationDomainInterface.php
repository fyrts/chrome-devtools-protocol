...
interface EmulationDomainInterface
{
	 ...
	 * @return void
	 */
	public function setCPUPerformanceOverride(
		ContextInterface $ctx,
		?SetCPUPerformanceOverrideRequest $request = null
	): void;
	 ...
	 * @return void
	 */
	public function setDataSaverOverride(ContextInterface $ctx, ?SetDataSaverOverrideRequest $request = null): void;
	 ...
	 * @return void
	 */
	public function setEmulatedOSTextScale(ContextInterface $ctx, ?SetEmulatedOSTextScaleRequest $request = null): void;
	...
	public function setVirtualKeyboardGeometryOverride(
		ContextInterface $ctx,
		?SetVirtualKeyboardGeometryOverrideRequest $request = null
	): void;
