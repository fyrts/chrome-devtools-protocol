...
interface NetworkDomainInterface
{
	 ...
	 * @return void
	 */
	public function configureDurableMessages(ContextInterface $ctx, ?ConfigureDurableMessagesRequest $request = null): void;
	 ...
	 *
	 * @param ContextInterface $ctx
	 * @param EnableDeviceBoundSessionsRequest $request
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param ContextInterface $ctx
	 * @param FetchSchemefulSiteRequest $request
	 *
	 * @return FetchSchemefulSiteResponse
	 */
	 ...
	 *
	 * Listener will be called whenever event Network.deviceBoundSessionsAdded is fired.
	 *
	 * @param callable $listener
	 *
	 * @return SubscriptionInterface
	 ...
	 * Triggered when the initial set of device bound sessions is added.
	 *
	 * Method will block until first Network.deviceBoundSessionsAdded event is fired.
	 *
	 * @param ContextInterface $ctx
	 *
	 * @return DeviceBoundSessionsAddedEvent
	 */
